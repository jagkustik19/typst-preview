...
pub fn outline(interner: &mut SpanInterner, document: &TypstDocument) -> Outline {
...
fn outline_item(interner: &mut SpanInterner, src: &HeadingNode, res: &mut Vec<OutlineItem>) {
